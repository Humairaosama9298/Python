...
class BookCollection:
    ...
    def __init__(self):
        """Initialize a new book collection with an emplt list and set up file storage."""
        self.book_list = []
        self.storage_file = "books_data.json"
        self.read_from_file()

    def read_from_file(self):
        """Load saved books from a JSON fileinto memory.
        if the file doesn't exist  ot its corrupted, start with an empty collection."""
        try:
